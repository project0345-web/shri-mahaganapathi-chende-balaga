...
async function checkBookingService() {
    ...
    status.innerHTML =
        '<span class="dot"></span>' +
        '<span>Checking booking service...</span>';
    ...
    try {
        ...
        status.className =
            'booking-service-status offline';
    ...
    async e => {
        ...
        try {
            ...
            if (!data.google_maps_link) {
                throw new Error(
                    'Please provide the Google Maps location.'
                );
            }

            if (!isGoogleMapsLink(data.google_maps_link)) {
                throw new Error(
            ...
            if (
                ...
                error.message?.startsWith('Please enter a valid')
            ) {
